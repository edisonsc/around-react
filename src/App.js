...
function App() {
  return (
   ...
   <header className="header">
        <img src="<%=require('./images/vector-logo.svg')%/>" alt="logo" className="logo"/>
    </header>
    <main>
        <section className="profile">
            <div className="profile__area">
               <button type="button" aria-label="avatar" className="button profile__avatar-button">
                 <img src="<%=require('./images/profile-image-jacques.jpg')%>" alt="Jacques Cousteau" className="profile__image"/></button>
